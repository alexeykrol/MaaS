...
> **Аналогия: Библиотека**
>
> Представь, что все воспоминания — это книги в огромной библиотеке. Когда ты спрашиваешь что-то, система должна быстро найти нужные книги.
>
> **Как можно искать книгу:**
> 1. **По названию (Tags):** "Дай книгу с названием Python". Работает только если название точно совпадает. Если книга называется "Программирование на Python" — не найдём.
> 2. **По смыслу (Vector):** "Дай книгу про змей" → находит и про питонов, и про удавов, потому что понимает СМЫСЛ, а не только слова.
> 3. **Спросить библиотекаря (Reranker):** После того как нашли 20 книг, умный библиотекарь отбирает 5 самых подходящих.
>
> **Почему это самый важный фактор?**
>
> Если библиотекарь приносит не те книги — неважно насколько умный читатель. Он будет отвечать по неправильным книгам.
...
>
> Ты говоришь официанту: "Можно мне, пожалуйста, что-нибудь вкусненькое с курицей?"
>
> **Плохой официант** запишет: "можно", "мне", "пожалуйста", "что-нибудь", "вкусненькое", "курицей"
> И пойдёт искать блюдо со словом "пожалуйста" в названии. Не найдёт ничего.
>
> **Хороший официант** поймёт: главное слово — "курица", и принесёт меню с блюдами из курицы.
>
> **Наша система сейчас — плохой официант.** Она берёт ВСЕ слова из вопроса и ищет по ним. Даже мусорные слова типа "можно", "мне", "пожалуйста".
>
> **Почему это важно?**
>
> Если мы ищем не те слова — мы не найдём нужные воспоминания, даже если они есть.
...
> **Аналогия: Коробки при переезде**
>
> Ты переезжаешь и складываешь вещи в коробки. На каждую коробку нужно написать, что внутри.
>
> **Плохие подписи:** "Вещи", "Разное", "Штуки"
> Через месяц ищешь зарядку от телефона — придётся открывать ВСЕ коробки.
>
> **Хорошие подписи:** "Кухня — посуда", "Электроника — зарядки, провода", "Спальня — постельное"
> Сразу знаешь, где искать зарядку.
>
> **Archivist — это тот, кто подписывает коробки с воспоминаниями.**
>
> Если он напишет на коробке "разговор" вместо "python, любимый язык, программирование" — потом мы эту коробку не найдём, когда спросят про программирование.
>
> **Почему это важно?**
>
> Плохая подпись = потерянное воспоминание НАВСЕГДА. И таких "потерянных коробок" будет всё больше.
...
> **Аналогия: Подсказки на экзамене**
>
> Представь, что ты на экзамене и можешь взять несколько шпаргалок. Сколько брать?
>
> **Взять 1 шпаргалку:**
> - Плюс: Не запутаешься, всё чётко
> - Минус: Если там нет нужной информации — пролетел
>
> **Взять 10 шпаргалок:**
> - Плюс: Наверняка найдёшь что-то полезное
> - Минус: Пока ищешь нужное — время кончится. Плюс там может быть устаревшая или неправильная информация, и ты запутаешься.
>
> **Взять 3 шпаргалки (текущее):**
> - Баланс: достаточно информации, но не слишком много шума
>
> **Как это работает в системе:**
>
> top_k = сколько воспоминаний брать из памяти для ответа.
> - Мало (1-2): точные ответы, но можем пропустить важное
> - Много (5-10): много информации, но ИИ может запутаться и начать выдумывать
...
> **Аналогия: Правила игры**
>
> Ты играешь с другом в игру. Перед началом говоришь правила:
>
> **Плохие правила:** "Ты всё знаешь про меня, отвечай на любые вопросы"
> Друг начнёт выдумывать: "Твой любимый цвет — синий!" (хотя ты ему не говорил)
>
> **Хорошие правила:** "Отвечай только если я тебе это рассказывал. Если не рассказывал — скажи 'не знаю'"
> Друг честно скажет: "Ты мне не говорил про любимый цвет"
>
> **System Prompt — это правила для ИИ.**
>
> Если мы скажем ИИ "у тебя есть память" — он будет делать вид, что помнит, даже если не помнит.
> Если скажем "используй ТОЛЬКО то, что я тебе дал, иначе скажи 'не знаю'" — он будет честным.
>
> **Почему это важно?**
>
> Правила определяют, будет ли ИИ выдумывать или честно признаваться, что не знает.
...
> **Аналогия: Калькулятор vs Компьютер**
>
> Тебе нужно посчитать что-то. Что использовать?
>
> **Простой калькулятор (gpt-4o-mini):**
> - Дешёвый, быстрый
> - Для простых задач: "2 + 2 = ?"
> - Для сложных задач может ошибиться
>
> **Мощный компьютер (gpt-4o):**
> - Дорогой, медленнее
> - Справится со сложными задачами: "Реши уравнение третьей степени"
> - Для простых задач — overkill (как гвоздь микроскопом)
>
> **Как это работает в системе:**
>
> - Простой вопрос "Как меня зовут?" → хватит mini (быстро, дёшево)
> - Сложный вопрос "Сравни мои предпочтения за последний год и дай совет" → нужен 4o (сложное рассуждение)
>
> **Почему это важно?**
>
> Более умная модель лучше понимает инструкции и реже выдумывает. Но стоит в 10 раз дороже.
...
> **Аналогия: Ищем друга в толпе**
>
> Ты ищешь друга Петю в большой толпе. По каким признакам искать?
>
> **По внешности (relevance):** Знаем, что у Пети рыжие волосы и очки
> **По времени (recency):** Знаем, что 5 минут назад он был у входа
>
> **Что важнее?**
>
> - Если ищешь конкретного человека → важнее внешность (relevance)
> - Если ищешь "кого видел недавно" → важнее время (recency)
>
> **Как это работает в системе:**
>
> Когда находим несколько воспоминаний, нужно решить какие важнее:
> - **Relevance (точность):** Насколько воспоминание соответствует вопросу
> - **Recency (свежесть):** Насколько недавно это было
>
> Вопрос "Какой у меня email?" → важнее relevance (email не меняется)
> Вопрос "Что мы обсуждали вчера?" → важнее recency (нужно свежее)
...
> **Аналогия: Размер шпаргалки**
>
> Ты готовишься к экзамену и можешь взять шпаргалку. Какого размера?
>
> **Маленькая шпаргалка (1000 токенов):**
> - Влезет мало информации (2-3 факта)
> - Зато дешёво и быстро прочитать
>
> **Большая шпаргалка (8000 токенов):**
> - Влезет много информации (10-15 фактов)
> - Но дорого (больше бумаги) и долго искать нужное
>
> **Как это работает в системе:**
>
> Token = примерно одно слово. Лимит 4000 токенов ≈ 3000 слов ≈ 6 страниц текста.
>
> Если воспоминаний много, а места мало — придётся что-то отбросить.
> Вопрос: ЧТО отбросить? Менее релевантное? Старое?
>
> **Почему это важно?**
>
> - Слишком мало места → потеряем важную информацию
> - Слишком много места → дорого и ИИ может запутаться в большом тексте
...
> **Аналогия: Рисование по трафарету vs Свободное рисование**
>
> Тебе нужно нарисовать кота. Как будешь рисовать?
>
> **По трафарету (temperature = 0):**
> - Всегда одинаковый кот
> - Предсказуемо, но скучно
> - Если трафарет неправильный — кот будет кривой
>
> **Свободно, как хочешь (temperature = 1):**
> - Каждый раз разный кот
> - Иногда красиво, иногда странно
> - Может нарисовать фиолетового кота с крыльями
>
> **Как это работает в системе:**
>
> Temperature = насколько ИИ может "творить"
> - **0.0** = всегда один и тот же ответ (роботический)
> - **0.7** = немного разнообразия (текущее)
> - **1.0** = максимальное разнообразие (может выдумывать)
>
> **Почему наименее важный фактор?**
>
> Для системы памяти важна точность, а не креативность. Нам нужны правильные ответы, а не оригинальные.
